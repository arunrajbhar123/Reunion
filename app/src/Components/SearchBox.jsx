...
export const SearchBox = () => {
  const [typeName, setTypeName] = useState("Buy");
  const location = useLocation();

  useEffect(() => {
    if (location.pathname !== "/") {
      setTypeName(location.pathname);
    }
  }, [location.pathname]);
...
const FilterSearch = () => {
  ...
  const { data, setData, page, setPage,clickDisable ,setClickDisable} = useContext(HouseContext);
